...
class TestStartPage:
    log = logging.getLogger('[StagitgirtPage]')
    ...
    def test_success_registration(self):
        ...
        # - Fill field
        username_field.send_keys(f'Irina{current_datetime}')
        sleep(1)
        ...
        login_field.clear()
        # - Fill field
        login_field.send_keys(f'test{current_datetime}@gmail.com')
        sleep(1)
        ...
        password_field.clear()
        # - Fill field
        password_field.send_keys(f'password{current_datetime}')
        sleep(1)
        ...
        assert success_message.text == f'Hello irina{current_datetime}, your feed is empty.', 'User is not registered'
